...
func BuildConfigFromFlags(masterUrl, kubeconfigPath string) (*rest.Config, error) {
	return fixAKS(clientcmd.BuildConfigFromFlags(masterUrl, kubeconfigPath))
}
...
func BuildConfigFromKubeconfigGetter(masterUrl string, kubeconfigGetter clientcmd.KubeconfigGetter) (*rest.Config, error) {
	return fixAKS(clientcmd.BuildConfigFromKubeconfigGetter(masterUrl, kubeconfigGetter))
}
...
func BuildConfigFromContext(kubeconfigPath, contextName string) (*rest.Config, error) {
	...
	return fixAKS(clientcmd.NewNonInteractiveDeferredLoadingClientConfig(loader, overrides).ClientConfig())
}
...
func fixAKS(cfg *rest.Config, err error) (*rest.Config, error) {
	if err != nil {
		return cfg, err
	}
