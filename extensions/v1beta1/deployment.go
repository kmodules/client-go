...
func CreateOrPatchDeployment(ctx context.Context, c kubernetes.Interface, meta metav1.ObjectMeta, transform func(*extensions.Deployment) *extensions.Deployment) (*extensions.Deployment, kutil.VerbType, error) {
...
func PatchDeployment(ctx context.Context, c kubernetes.Interface, cur *extensions.Deployment, transform func(*extensions.Deployment) *extensions.Deployment) (*extensions.Deployment, kutil.VerbType, error) {
...
func PatchDeploymentObject(ctx context.Context, c kubernetes.Interface, cur, mod *extensions.Deployment) (*extensions.Deployment, kutil.VerbType, error) {
	...
	out, err := c.ExtensionsV1beta1().Deployments(cur.Namespace).Patch(ctx, cur.Name, types.StrategicMergePatchType, patch, metav1.PatchOptions{})
...
func TryUpdateDeployment(ctx context.Context, c kubernetes.Interface, meta metav1.ObjectMeta, transform func(*extensions.Deployment) *extensions.Deployment) (result *extensions.Deployment, err error) {
	...
	err = wait.PollImmediate(kutil.RetryInterval, kutil.RetryTimeout, func() (bool, error) {
		...
		if kerr.IsNotFound(e2) {
			...
			result, e2 = c.ExtensionsV1beta1().Deployments(cur.Namespace).Update(ctx, transform(cur.DeepCopy()), metav1.UpdateOptions{})
			return e2 == nil, nil
		}
