...
func CreateOrPatchReplicaSet(ctx context.Context, c kubernetes.Interface, meta metav1.ObjectMeta, transform func(*extensions.ReplicaSet) *extensions.ReplicaSet) (*extensions.ReplicaSet, kutil.VerbType, error) {
...
func PatchReplicaSet(ctx context.Context, c kubernetes.Interface, cur *extensions.ReplicaSet, transform func(*extensions.ReplicaSet) *extensions.ReplicaSet) (*extensions.ReplicaSet, kutil.VerbType, error) {
...
func PatchReplicaSetObject(ctx context.Context, c kubernetes.Interface, cur, mod *extensions.ReplicaSet) (*extensions.ReplicaSet, kutil.VerbType, error) {
	...
	out, err := c.ExtensionsV1beta1().ReplicaSets(cur.Namespace).Patch(ctx, cur.Name, types.StrategicMergePatchType, patch, metav1.PatchOptions{})
	return out, kutil.VerbPatched, err
}

func TryUpdateReplicaSet(ctx context.Context, c kubernetes.Interface, meta metav1.ObjectMeta, transform func(*extensions.ReplicaSet) *extensions.ReplicaSet) (result *extensions.ReplicaSet, err error) {
	attempt := 0
	err = wait.PollImmediate(kutil.RetryInterval, kutil.RetryTimeout, func() (bool, error) {
		...
		if kerr.IsNotFound(e2) {
			...
			result, e2 = c.ExtensionsV1beta1().ReplicaSets(cur.Namespace).Update(ctx, transform(cur.DeepCopy()), metav1.UpdateOptions{})
			return e2 == nil, nil
		}
