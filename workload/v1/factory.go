...
func newWithObject(t metav1.TypeMeta, o metav1.ObjectMeta, tpl core.PodTemplateSpec, obj runtime.Object) *Workload {
	return &Workload{
		TypeMeta:   t,
		ObjectMeta: o,
		Template:   tpl,
...
func ConvertToWorkload(obj runtime.Object) (*Workload, error) {
	switch t := obj.(type) {
	case *core.Pod:
		return newWithObject(t.TypeMeta, t.ObjectMeta, core.PodTemplateSpec{ObjectMeta: t.ObjectMeta, Spec:t.Spec}, obj), nil
		// ReplicationController
	case *core.ReplicationController:
		if t.Spec.Template == nil {
			t.Spec.Template = &core.PodTemplateSpec{}
		}
		return newWithObject(t.TypeMeta, t.ObjectMeta, *t.Spec.Template, obj), nil
		// Deployment
	...
	case *batchv1beta1.CronJob:
		return newWithObject(t.TypeMeta, t.ObjectMeta, t.Spec.JobTemplate.Spec.Template, obj), nil
	default:
...
func ApplyWorkload(obj runtime.Object, w *Workload) error {
	...
	case *core.Pod:
		...
		t.Spec = w.Template.Spec
		// ReplicationController
	case *core.ReplicationController:
		t.ObjectMeta = w.ObjectMeta
		t.Spec.Template = &w.Template
		// Deployment
	case *extensions.Deployment:
		t.ObjectMeta = w.ObjectMeta
		t.Spec.Template = w.Template
	...
	case *batchv1beta1.CronJob:
		t.ObjectMeta = w.ObjectMeta
		t.Spec.JobTemplate.Spec.Template = w.Template
	default:
